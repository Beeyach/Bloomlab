...
- A live rubric response misattributed an authored client question to the learner in its `questions` explanation. The API returned a complete eight-item rubric and score 82, but this does not establish feedback quality. CALL-003 remains IMPLEMENTED_UNVERIFIED.
