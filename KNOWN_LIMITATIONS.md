...
matrix and remediation review cite direct evidence; the historical audit/decision record is retained.
...
| --- | --- | --- | --- |
| GHL-AGENCY-SAAS — [SaaS Mode](https://help.gohighlevel.com/support/solutions/articles/155000007979-what-is-an-agency-sub-account-in-highlevel-) | C | Conceptual scope decisions, not a native product simulator or live acceptance. Conceptual instruction and objective local policy fixtures only. No account provisioning, billing, app build, installation or live permissions are simulated. Plan-specific eligibility must be checked before real work. | 2026-09-09: Official HighLevel documentation read on 2026-09-09. SaaS, white-label and Marketplace operations are specialist-only. |
| GHL-AGENCY-SUBACCOUNTS — [Agency Sub-Accounts](https://help.gohighlevel.com/support/solutions/articles/155000007979-what-is-an-agency-sub-account-in-highlevel-) | C | Conceptual scope decisions, not a native product simulator or live acceptance. Conceptual instruction and objective local policy fixtures only. No account provisioning, billing, app build, installation or live permissions are simulated. Plan-specific eligibility must be checked before real work. | 2026-09-09: Official HighLevel documentation read on 2026-09-09. SaaS, white-label and Marketplace operations are specialist-only. |
| GHL-AGENCY-WHITELABEL — [White-Label Desktop App](https://help.gohighlevel.com/support/solutions/articles/155000008099-white-label-desktop-app-setup-guide) | C | Conceptual scope decisions, not a native product simulator or live acceptance. Conceptual instruction and objective local policy fixtures only. No account provisioning, billing, app build, installation or live permissions are simulated. Plan-specific eligibility must be checked before real work. | 2026-09-09: Official HighLevel documentation read on 2026-09-09. SaaS, white-label and Marketplace operations are specialist-only. |
| GHL-AI-ACTIVITY — [Managed Agent Activity Feed](https://help.gohighlevel.com/support/solutions/articles/155000008415-managed-agent-activity-feed-monitor-debug-ai-agents) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-ASK — [Ask AI](https://help.gohighlevel.com/support/solutions/articles/155000005327-overview-of-ask-ai-assistant) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-CONVERSATION — [Conversation AI](https://help.gohighlevel.com/support/solutions/articles/155000004401-setting-up-conversation-ai) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-DECISION-MAKER — [AI Decision Maker](https://help.gohighlevel.com/support/solutions/articles/155000005649-workflow-action-ai-decision-maker) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-EXTRACT-DATA — [AI Extract Data](https://help.gohighlevel.com/support/solutions/articles/155000007992) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-FLOW-AGENTS — [Flow Agents in Agent Studio](https://help.gohighlevel.com/support/solutions/articles/155000006058) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Current comparison uses Managed Agents (formerly Super Agents); some official pages retain SuperAgents wording. Flow Agents maintain existing visual agents; verify current account rollout before new creation. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Current comparison uses Managed Agents (formerly Super Agents); some official pages retain SuperAgents wording. Flow Agents maintain existing visual agents; verify current account rollout before new creation. |
| GHL-AI-KNOWLEDGE — [Knowledge Base](https://help.gohighlevel.com/support/solutions/articles/155000005266-knowledge-base-integration-for-voice-ai-agents) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-LOGS — [Agent Logs](https://help.gohighlevel.com/support/solutions/articles/155000007657-agent-logs-overview) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-MANAGED — [Managed Agents](https://help.gohighlevel.com/support/solutions/articles/155000008362-super-agents-conversation-ai-ask-ai-what-s-the-difference-) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Current comparison uses Managed Agents (formerly Super Agents); some official pages retain SuperAgents wording. Flow Agents maintain existing visual agents; verify current account rollout before new creation. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Current comparison uses Managed Agents (formerly Super Agents); some official pages retain SuperAgents wording. Flow Agents maintain existing visual agents; verify current account rollout before new creation. |
| GHL-AI-MCP — [MCP Connectors for Managed Agents](https://help.gohighlevel.com/support/solutions/articles/155000008304-mcp-connectors) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Connector article scopes current availability to Managed Agents and Ask AI, with Voice/Conversation AI described as future support. Do not infer universal connector availability from Skills Platform. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Connector article scopes current availability to Managed Agents and Ask AI, with Voice/Conversation AI described as future support. Do not infer universal connector availability from Skills Platform. |
| GHL-AI-SKILLS — [Skills Platform for AI Agents](https://help.gohighlevel.com/support/solutions/articles/155000008315) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-VOICE — [Voice AI](https://help.gohighlevel.com/support/solutions/articles/155000004107-how-to-create-voice-ai-agents) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-AI-WORKFLOW-AGENT — [AI Agent](https://help.gohighlevel.com/support/solutions/articles/155000007600-workflow-action-ai-agent) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-API-GET-CONTACT — [Get Contact](https://marketplace.gohighlevel.com/docs/ghl/contacts/get-contact/index.html) | C | The learner inspects a current documented request contract; Bloomlab does not call Get Contact. Contract-reading exercise only, with a fictional contact identity. No request or real account access. The v3 introduction documents the /v3 route prefix; verify complete client base URL and endpoint path before real use. | 2026-09-09: Read the official v3 Get Contact endpoint and Contacts API v3 introduction on 2026-09-09. GET, contactId, Version v3 and JSON response are documented. |
| GHL-API-PRIVATE-INTEGRATIONS — [Private Integrations](https://marketplace.gohighlevel.com/docs/Authorization/PrivateIntegrationsToken/index.html) | C | Local contract-inspection fixtures only; no live API, signature verification or account connection. No token generation, credential capture or real API calls. OAuth applications remain specialist work. | 2026-09-09: Read the official reference on 2026-09-09; authorisation distinguishes Private Integrations and OAuth. Current Marketplace webhook signature guidance is recorded separately in GHL-API-WEBHOOKS. |
| GHL-API-VERSIONING — [API Versioning](https://marketplace.gohighlevel.com/docs/Versioning/index.html) | C | Local contract-inspection fixtures only; no live API, signature verification or account connection. The supplied request contract is fictional; supported version and endpoint schema must be checked before real work. | 2026-09-09: Read the official reference on 2026-09-09; versioning lists v3 and date-based versions. Current Marketplace webhook signature guidance is recorded separately in GHL-API-WEBHOOKS. |
| GHL-API-WEBHOOKS — [Webhook Integration Guide](https://marketplace.gohighlevel.com/docs/webhook/WebhookIntegrationGuide/) | C | Local contract-inspection fixtures only; no live API, signature verification or account connection. Marketplace event delivery is distinct from workflow webhook actions/triggers. Local signature-valid flags are supplied fixtures, not cryptographic verification or live delivery. | 2026-09-09: Read the official reference on 2026-09-09. From 1 September 2026, HighLevel Marketplace webhook deliveries use X-GHL-Signature with Ed25519 only. Reject a missing signature or failed verification. The dated deprecation notice supersedes older examples still on the page. Historical context: X-WH-Signature (RSA-SHA256) was deprecated on 1 September 2026; it is not supported for current delivery. Non-2xx or missing responses are retried with backoff and jitter. |
| GHL-APP-DISTRIBUTION — [Marketplace App Distribution](https://help.gohighlevel.com/support/solutions/articles/155000002141-marketplace-app-distribution-type) | C | Conceptual scope decisions, not a native product simulator or live acceptance. Conceptual instruction and objective local policy fixtures only. No account provisioning, billing, app build, installation or live permissions are simulated. Plan-specific eligibility must be checked before real work. | 2026-09-09: Official HighLevel documentation read on 2026-09-09. SaaS, white-label and Marketplace operations are specialist-only. |
| GHL-CAL-CALENDARS — [Calendars](https://help.gohighlevel.com/support/solutions/articles/48001155718-adjusting-availability-settings-for-individual-calendars) | B | Training approximation — Personal, Round Robin, Service and Class Booking use the same availability engine. Class seat capacity and service resource reservations have their own current registry records. Collective, Group and Event calendars and payment at booking remain real-GHL practice. Simulated — Personal Booking, Round Robin and Service calendars with weekly working hours, appointment duration, slot interval, pre and post buffer, minimum scheduling notice, a booking window, a team with an order, both round-robin distribution methods, staff selection, services that set their own duration and eligible staff, meeting locations, and cancellation and reschedule permissions with a cutoff. Not simulated — date-specific hours, linked and conflict calendars, Look Busy, appointments-per-day limits, calendar groups, recurring appointments, Collective, Group and Event calendars, the separate Rooms & Equipment configuration, and payment at booking. Phase 25 adds Class Booking seats and service resources, separately sourced in GHL-CAL-CLASSES and GHL-CAL-RESOURCES. Optimize for Equal Distribution counts each team member's bookings on that calendar in the slot's own month and gives the booking to whoever has fewest, ties broken by the order the calendar lists them. HighLevel additionally limits a member's availability temporarily when they run too far ahead of the team; that part is not simulated. Zoom and Google Meet locations store a link the learner supplies. Bloomlab creates no meeting on either platform and generates no dynamic link. Working hours are whole windows inside one day in the calendar's own zone, between 00:00 and 23:59. A window that crosses midnight is authored as two. | 2026-09-04: Calendar types, availability settings, both round-robin distribution methods, staff selection, service duration and staff assignment, the six meeting-location kinds and the cancellation and reschedule toggles were confirmed on 2026-09-04 from search-result summaries of the official help-centre articles listed above. The articles could not be opened directly from the build environment, whose proxy refuses help.gohighlevel.com with a 403. |
| GHL-CAL-CLASSES — [Class Booking](https://help.gohighlevel.com/support/solutions/articles/155000000956-show-seats-per-slot-for-class-booking-on-the-booking-widget) | B | One host and overlapping attendee seat counts use the shared availability engine. Weekly working windows, notice and other-calendar host conflicts still apply. Recurring series, meeting-platform capacity and real booking widgets are not simulated. One host and overlapping attendee seat counts use the shared availability engine. Weekly working windows, notice and other-calendar host conflicts still apply. Recurring series, meeting-platform capacity and real booking widgets are not simulated. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-CAL-RENTALS — [Rentals](https://help.gohighlevel.com/support/solutions/articles/155000006740-guide-to-the-rentals-public-beta) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-CAL-RESOURCES — [Resources in Services](https://help.gohighlevel.com/support/solutions/articles/155000003505-resources-in-services) | B | A service selects one available equivalent resource, with account-wide capacity and booking-time reservation. Location-specific capacities, resource-specific hours and the separate Rooms & Equipment configuration are not reproduced. A service selects one available equivalent resource, with account-wide capacity and booking-time reservation. Location-specific capacities, resource-specific hours and the separate Rooms & Equipment configuration are not reproduced. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-CAL-SERVICES — [Services](https://help.gohighlevel.com/support/solutions/articles/155000006096) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-CONV-CONVERSATIONS — [Conversations](https://help.gohighlevel.com/support/solutions/articles/155000006610-getting-started-with-the-conversations-tab) | B | Training approximation — synthetic SMS/email threads and workflow replies only; no live delivery or complete HighLevel inbox. Bloomlab reads synthetic SMS/email threads from the shared simulated account; injected replies and staff messages never reach a live inbox. Native multi-channel inboxes, permissions, internal collaboration, attachments, filtering and rich email composition are not simulated. | 2026-09-10: Read the official Conversations guide on 2026-09-10 for the module name and native inbox/composer scope. No live account or device acceptance was performed. |
| GHL-CRM-COMPANIES — [Companies](https://help.gohighlevel.com/support/solutions/articles/155000004430-getting-started-with-companies) | B | Company names and contact-company references are editable. Company custom fields, bulk imports, permissions and company-based workflow builders are not simulated. Company names and contact-company references are editable. Company custom fields, bulk imports, permissions and company-based workflow builders are not simulated. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-CRM-CUSTOM-OBJECTS — [Custom Objects](https://help.gohighlevel.com/support/solutions/articles/155000003896-getting-started-with-custom-objects) | B | Schemas, typed records and labelled many-to-many contact associations are simulated. The narrow created/updated condition-to-internal-notification automation is not a complete object-based workflow builder. No outbound delivery, object-to-object associations, unique fields, bulk operations or platform object limits are reproduced. Schemas, typed records and labelled many-to-many contact associations are simulated. The narrow created/updated condition-to-internal-notification automation is not a complete object-based workflow builder. No outbound delivery, object-to-object associations, unique fields, bulk operations or platform object limits are reproduced. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-CRM-NOTES — [Notes](https://help.gohighlevel.com/support/solutions/articles/155000004555-efficiently-using-highlevel-notes-for-managing-contacts-opportunities-and-company-records) | B | Training approximation — Bloomlab stores one plain-text body per note against one record. HighLevel also supports rich text, attachments, company notes and notes linked to a contact and an opportunity at once. Simulated — plain-text internal notes on a contact or an opportunity, stamped with simulator time. Not simulated — rich text, attachments, company notes, and the note-association feature that links one note to both a contact and an opportunity. | 2026-09-03: Internal-only visibility, and notes living on contacts, opportunities and companies, confirmed through search summaries of the official help article, 2026-09-03. Direct page fetch was blocked by the build environment's egress proxy. |
| GHL-CRM-OWNERS — [Allow different owners for contacts and its opportunities](https://help.gohighlevel.com/support/solutions/articles/155000002273-how-to-decouple-owners-for-contacts-and-opportunities) | B | Training approximation — Bloomlab always behaves as though "Allow different owners for contacts and its opportunities" is on, and does not reproduce the follower-sync sub-settings. Simulated — a contact owner and an opportunity owner, each a user in the account, allowed to differ. A new opportunity takes the contact's owner and can then be changed. Not simulated — the sub-account toggle itself (Bloomlab's account behaves as though it is on), and the two follower-sync sub-settings that keep a contact follower and an opportunity owner in step. | 2026-09-03: The setting's official name, the default-to-contact-owner behaviour on opportunity creation, and the two follower-sync sub-settings confirmed through search summaries of the official help article, 2026-09-03. Direct page fetch was blocked by the build environment's egress proxy. |
| GHL-CRM-SMART-LISTS — [Smart Lists](https://help.gohighlevel.com/support/solutions/articles/155000007530-advanced-filters-in-smart-lists) | B | Live contact segmentation supports one all/any rule group, typed equality, contains, empty and numeric greater-than. Nested groups, sharing, company/object lists, every field and channel-specific DND filters are not simulated. Live contact segmentation supports one all/any rule group, typed equality, contains, empty and numeric greater-than. Nested groups, sharing, company/object lists, every field and channel-specific DND filters are not simulated. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-CRM-TASKS — [Tasks](https://help.gohighlevel.com/support/solutions/articles/155000005529-unified-task-management-across-contacts-and-opportunities) | B | Training approximation — Bloomlab models one linked record per task and a complete/reopen status. HighLevel adds priorities, recurrence, bulk operations and multi-object associations. Simulated — title, description, due date in simulator time, an assignee from the account's users, one linked contact or opportunity, and completing or reopening it. Not simulated — priorities, recurring tasks, bulk actions, and linking one task to as many as ten records of each object type. | 2026-09-03: The task form's fields (title, description, due date, assignee) and task assignment across contacts and opportunities confirmed through search summaries of the official help article, 2026-09-03. Direct page fetch was blocked by the build environment's egress proxy. |
| GHL-FORM-FORMS — [Forms](https://help.gohighlevel.com/support/solutions/articles/155000006719-create-forms-surveys-inside-the-site-builder) | B | Training approximation — form submissions create or update contacts and fire Form Submitted; the visual builder is practised in GHL. Field mapping to standard and custom fields is simulated; styling, conditional logic and embed modes are not. | 2026-09-02: Name and builder location confirmed on the help-center article, 2026-09-02. |
| GHL-FORM-SURVEYS — [Surveys](https://help.gohighlevel.com/support/solutions/articles/155000006719-create-forms-surveys-inside-the-site-builder) | B | Training approximation — survey submissions create or update contacts and fire Survey Submitted; the question builder, logic and scoring are practised in GHL. Simulated — ordered questions mapped to contact fields; a submission creates or updates a contact and fires Survey Submitted. Not simulated — multi-page surveys, conditional logic, scoring, disqualification, styling or embed modes. | 2026-09-04: Name and builder location confirmed through a search-result summary of the official article on 2026-09-04; the help centre is blocked from this build environment. |
| GHL-FUNNEL-FUNNELS — [Funnels](https://help.gohighlevel.com/support/solutions/articles/155000005057-getting-started-launch-a-funnel) | C | Training approximation — Bloomlab simulates a funnel's conversion architecture, not HighLevel's page builder. Layout, styling and publishing are practised in GHL. Simulated — a funnel as ordered steps, what each step is for, what is on each step in order, and which account form, survey, calendar or product a step uses. Not simulated — the page editor, sections, rows, columns, elements, styling, templates, domains, tracking pixels, split tests, AI page generation or publishing. Bloomlab's step purposes and block roles are its own conversion vocabulary, not HighLevel controls; the interface says so on every one. | 2026-09-04: Location (Sites → Funnels) and the step-series model confirmed through search-result summaries of the official articles on 2026-09-04; the help centre itself is unreachable from this build environment. |
| GHL-FUNNEL-WEBSITES — [Websites](https://help.gohighlevel.com/support/solutions/articles/155000001633) | C | The native page editor, publishing and domains are not simulated. Field Ready compares paths and practises native layout manually in a training account. The native page editor, publishing and domains are not simulated. Field Ready compares paths and practises native layout manually in a training account. | 2026-09-08: Read the official HighLevel support article directly on 2026-09-08. Only the documented record/page capability is taught; no advanced UI is claimed. |
| GHL-MEM-CLIENT-PORTAL — [Client Portal](https://help.gohighlevel.com/support/solutions/articles/155000008455-unified-client-portal-experience) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MEM-COMMUNITIES — [Communities](https://help.gohighlevel.com/support/solutions/articles/155000000297-communities-how-to-manage-content) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MEM-COURSES — [Courses](https://help.gohighlevel.com/support/solutions/articles/155000008272-tags-in-courses) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MEM-MEMBERSHIPS — [Memberships](https://help.gohighlevel.com/support/solutions/articles/155000002045) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MKT-AFFILIATES — [Affiliate Manager](https://help.gohighlevel.com/support/solutions/articles/155000003633-glossary) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MKT-PROSPECTING — [Prospecting Tool](https://help.gohighlevel.com/support/solutions/articles/48001231875-how-to-generate-leads-using-the-highlevel-prospecting-tool) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-MKT-SOCIAL-PLANNER — [Social Planner](https://help.gohighlevel.com/support/solutions/articles/155000005063) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-PAY-CONTRACTS — [Documents & Contracts](https://help.gohighlevel.com/support/solutions/articles/155000000594) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-PAY-ESTIMATES — [Estimates](https://help.gohighlevel.com/support/solutions/articles/155000003675-how-to-create-and-send-estimates-using-in-highlevel) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-PAY-INVOICES — [Invoices](https://help.gohighlevel.com/support/solutions/articles/155000005075-getting-started-create-and-send-invoices) | B | A local single-line USD invoice names a contact and snapshots its price. Open and paid are simulated; no real sending, taxes, payment plans, recurring templates or full platform invoice lifecycle is reproduced. A local single-line USD invoice names a contact and snapshots its price. Open and paid are simulated; no real sending, taxes, payment plans, recurring templates or full platform invoice lifecycle is reproduced. | 2026-09-09: Current official article read on 2026-09-09. Lab boundaries are local training approximations, not a real account verification. |
| GHL-PAY-LINKS — [Payment Links](https://help.gohighlevel.com/support/solutions/articles/155000002177-payment-links) | B | A local link selects one explicit price and can be activated or deactivated. No public URL, real hosted checkout, provider, localisation, multi-item selection or delivery is created. A local link selects one explicit price and can be activated or deactivated. No public URL, real hosted checkout, provider, localisation, multi-item selection or delivery is created. | 2026-09-09: Current official article read on 2026-09-09. Lab boundaries are local training approximations, not a real account verification. |
| GHL-PAY-PRODUCTS — [Products](https://help.gohighlevel.com/support/solutions/articles/155000005071-getting-started-create-sell-products) | B | Local named products and immutable USD one-time/monthly/yearly prices. No variants, taxes, trials, coupons, provider credentials or actual charges. The first Lab price sets the product default used by existing Funnel checkout; additional prices are selected in Payments Lab. Local named products and immutable USD one-time/monthly/yearly prices. No variants, taxes, trials, coupons, provider credentials or actual charges. The first Lab price sets the product default used by existing Funnel checkout; additional prices are selected in Payments Lab. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-PAY-SUBSCRIPTIONS — [Subscriptions](https://help.gohighlevel.com/support/solutions/articles/155000006066-how-to-modify-existing-subscriptions) | B | Local monthly/yearly terms, explicit synthetic charge attempts, incomplete/active/past-due/cancelled states and cancellation. No provider, automatic schedule, proration, trials, date editing or multi-product subscription changes. Local monthly/yearly terms, explicit synthetic charge attempts, incomplete/active/past-due/cancelled states and cancellation. No provider, automatic schedule, proration, trials, date editing or multi-product subscription changes. | 2026-09-09: Current official article read on 2026-09-09. Lab boundaries are local training approximations, not a real account verification. |
| GHL-PHONE-IVR — [Interactive Voice Response (IVR)](https://help.gohighlevel.com/support/solutions/articles/155000001200) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-REP-ADS — [Google Ads Widgets for Dashboards & Reporting](https://help.gohighlevel.com/support/solutions/articles/155000008112-google-ads-widgets-for-dashboards-reporting) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-REP-CUSTOM-REPORTS — [Custom Reports](https://help.gohighlevel.com/support/solutions/articles/155000003965-how-to-create-custom-reports-and-schedule-reports) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
| GHL-REP-REVIEWS — [Review Request Messaging](https://help.gohighlevel.com/support/solutions/articles/48000980328-reputation-management-how-to-customize-the-review-request-messages-sms-email-) | C | Local contract reasoning only, not a full Lab or real-GHL acceptance. Conceptual instruction and objective local policy/trace fixtures only. No live product execution, external account, paid provider, publishing, calling or autonomous action is simulated. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. | 2026-09-09: Current official HighLevel documentation read on 2026-09-09. Only the explicitly described product boundary is taught; entitlements, live permissions and rollout must be verified in the intended account. |
...
| GHL-WF-PAYMENT-RECEIVED — [Payment Received](https://help.gohighlevel.com/support/solutions/articles/155000003534-workflow-trigger-payment-received) | B | PAYMENT_RECEIVED and PAYMENT_FAILED share this adapter with success/failed status, product, source and amount filters. The official guide introduction emphasises success but its Payment Status instructions and FAQ explicitly include failure. No gateway requests, all native subfilters or automatic billing are simulated. PAYMENT_RECEIVED and PAYMENT_FAILED share this adapter with success/failed status, product, source and amount filters. The official guide introduction emphasises success but its Payment Status instructions and FAQ explicitly include failure. No gateway requests, all native subfilters or automatic billing are simulated. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
| GHL-WF-REFUND — [Refund](https://help.gohighlevel.com/support/solutions/articles/155000003537-trigger-refund) | B | Only full successful local refunds are simulated; product and amount filters reach the shared workflow engine. Failed and partial refund attempts and provider-specific behaviour are not simulated. Only full successful local refunds are simulated; product and amount filters reach the shared workflow engine. Failed and partial refund attempts and provider-specific behaviour are not simulated. | 2026-09-09: Read the current official HighLevel article on 2026-09-09. Local behaviour is deliberately narrower than the platform; no real account verification is implied. |
...
- Mac Safari Private Browsing failed local Blob persistence (`UnknownError`: Error preparing Blob/File data to be stored in object store). This is a real observed limitation; local-first recovery has not been bypassed. Repeated iPhone microphone permission prompts are an annoyance; the microphone is still released after each recording. The user describes the turn-based call as slow and noticeably scripted; no free-form realism is claimed.
- CALL-003 is PASSED after remediation of the twice-failed human proposal feedback. A fictional reproduction found missing rubric items, then an unsupported learner quotation in the single repair. The corrected provider contract requires all eight dimensions while preserving every grading/citation validator and one-repair limit. A fresh deployed proposal passed attribution review and zero-cost replay; the original human run then completed on its first corrected response without new recordings ($0.0154112, no remaining reservation). Historical rejected prose was not retained, so the old responses' exact validation subtypes remain unavailable. One accepted synthetic sample and human recovery do not establish a population failure rate. See `docs/reviews/phase-21-feedback-reliability.md`.
- Guided Northwind can repeat clarification after unrelated replies: its intended path is four turns, while the authored limit is 12 to allow recovery. Final UX polish adds a current authored recovery cue in guided/practice only and explicit loading feedback at long-running controls. This does not change language interpretation or make the roleplay naturally conversational. Full physical-device acceptance remains incomplete; see `docs/reviews/phase-21-final-ux-polish.md`.
- The iPhone Safari offline transcription retry passed using the same saved recording. Retained audio deletion disabled replay, but the user did not hear retained replay audio. The later Northwind run resumed earlier off-path replies and reached turn 7; it does not prove a fresh routing defect. Missing loading UX on that device likely reflects an older PWA bundle and is not acceptance of `219e2ef`.
- Unfinished calls now offer explicit restart with authenticated deletion of all raw recordings, including retained audio only after clear consent. Failure preserves the active call and remaining audio for cleanup retry. Successful restart replaces the local attempt ID without completed/mastery evidence; private server call/transcript metadata and generated client-voice cache remain orphaned, not erased.
- PWA updates show a visible prompt and loaded browser/Worker build IDs. Unsafe call steps defer reload, and reaching a checkpoint still requires an explicit reload action. Already-loaded historical JavaScript cannot gain this behavior retroactively; the first adoption follows the normal service-worker lifecycle. No storage clearing or unsafe forced reload was added. Automated two-build Chromium checks cannot establish physical Safari update behavior. See `docs/reviews/phase-21-session-freshness.md`.
...
- Failed update/build checks now expose a retry even before an update is detected. This fixes the hidden failure state; it does not establish physical Safari update behavior or change first-adoption service-worker limits. See `docs/reviews/phase-21-update-check-recovery.md`.
- VOI-003 is PASSED: deterministic safe literal quote selection reached a real authorized dynamic response; ElevenLabs billed 69 characters once, and the identical request reused private audio with no second purchase. Dynamic speech remains constrained to confirmed learner text plus the authored question. Missing static audio uses text; uncertain provider purchases require operator reconciliation. No arbitrary-text synthesis, full-duplex streaming, background STT, active-call cross-device resume or Boss Client continuity is claimed.
- Seven Phase 21 targets remain IMPLEMENTED_UNVERIFIED for the mandatory real human microphone checks. Broad privacy/infrastructure rows and PRI-001, PRI-002, NEG-003, EXR-024 carryovers retain their prior status. The final independent audit, production secret setup and reviewed gate changes remain before production readiness. Details: `docs/reviews/phase-21-call-room.md`.
- An earlier normal-budget diagnostic hit the old 30-second provider deadline. Its billing is unknown and its $5.04096 conservative reservation remains on a revoked disposable reviewer; it must not be silently released or reported as actual spend. Call grading now has a tested 90-second bound per response, with the same token cap and one repair. Known Anthropic cost of that earlier remediation is $0.0671385, excluding the unknown bill. This later feedback-reliability follow-up adds $0.0674497, including the successful human retry; see its separate evidence ledger.
