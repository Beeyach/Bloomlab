...
export const APP_ROUTES: readonly AppRoute[] = [
  ...
  },
  {
    id: 'funnel',
    path: '/funnel',
    Component: lazy(() => import('../funnel/FunnelLab')),
  },
  {
    id: 'calendar',
    path: '/calendar',
    Component: lazy(() => import('../calendar/CalendarLab')),
  },
  {
    id: 'reporting',
    path: '/reporting',
    Component: lazy(() => import('../reporting/ReportingLab')),
  },
  {
    path: '/payments',
    id: 'payments',
    Component: lazy(() => import('../payments/PaymentsLab')),
  },
  {
    id: 'incident',
    path: '/incident',
    Component: lazy(() => import('../incident/IncidentRoom')),
  },
  {
    id: 'incident-case',
    path: '/incident/:scenarioId',
    Component: lazy(() => import('../incident/IncidentRoom')),
  },
  {
    id: 'conversations',
  ...
  },
  {
    id: 'portfolio',
    path: '/portfolio',
    Component: lazy(() => import('../portfolio/PortfolioScreen')),
  },
  {
    id: 'portfolio-item',
    path: '/portfolio/:templateId',
    Component: lazy(() => import('../portfolio/PortfolioScreen')),
  },
  {
    id: 'playground',
